    ...
    <section className='features-main my-2'>
      <div className='container grid grid-3'>
        <div className='card flex'>
          ...
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas nemo saepe corrupti et dolorem voluptate at, nostrum rem voluptatem ab
            alias quia molestiae ea, libero nihil deserunt. Molestias, eum? Necessitatibus!
          </p>
        </div>
        <div className='card flex'>
